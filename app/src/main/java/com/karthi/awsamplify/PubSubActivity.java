...
public class PubSubActivity extends Activity {
    ...
    private static final String CUSTOMER_SPECIFIC_ENDPOINT = "a2lq7g430de5sl-ats.iot.ap-south-1.amazonaws.com";
    // Name of the AWS IoT policy to attach to a newly created certificate
    private static final String AWS_IOT_POLICY_NAME = "iotMobileAppPolicyForPubSub";
        ...
        try {
            mqttManager.connect(clientKeyStore, new AWSIotMqttClientStatusCallback() {
                ...
                public void onStatusChanged(final AWSIotMqttClientStatus status,
                    ...
                    Timber.d("Status = " + String.valueOf(status));
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    try {
                                        ...
                                        Timber.d("Message arrived:");
                                        Timber.d("   Topic: " + topic);
                                        Timber.d(" Message: " + message);

                                        tvLastMessage.setText(message);
                                    } catch (UnsupportedEncodingException e) {
                                        Timber.e(e, "Message encoding error.");
                                    }
                                }
                            });
                        }
    ...
    public void publishClick(final View view) {
        ...
        try {
            reported.put("value", Integer.parseInt(msg));
        ...
        Log.d("log", root.toString());

        try {
            mqttManager.publishString(root.toString(), topic, AWSIotMqttQos.QOS0);
        } catch (Exception e) {
